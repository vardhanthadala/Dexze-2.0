    ...
    <div className="contact-page-body">
      <style>{`
        ...
        @media (max-width: 600px) {
          ...
          .form-title h2 { font-size: 16px; line-height: 1.5; padding: 0 10px; }
          .form-title .subtitle::before, .form-title .subtitle::after { width: 15px; }
        }

        @media (min-width: 1400px) {
          .form-title h2 { font-size: 24px; max-width: 800px; }
          .form-title .subtitle { font-size: 13px; }
        }
        @media (min-width: 2000px) {
          .form-title h2 { font-size: 30px; max-width: 1000px; }
          .form-title .subtitle { font-size: 14px; }
        }
        @media (min-width: 3000px) {
          .form-title h2 { font-size: 38px; max-width: 1300px; }
          .form-title .subtitle { font-size: 16px; letter-spacing: 0.14em; }
        }
        @media (min-width: 3840px) {
          .form-title h2 { font-size: 44px; max-width: 1600px; }
          .form-title .subtitle { font-size: 18px; }
        }
        ...
        @media (min-width: 1400px) {
          .projects-heading { font-size: 22px; }
        }
        @media (min-width: 2000px) {
          .projects-heading { font-size: 26px; margin-bottom: 24px; padding-bottom: 16px; }
        }
        @media (min-width: 3000px) {
          .projects-heading { font-size: 34px; margin-bottom: 32px; border-bottom-width: 3px; }
        }
        @media (min-width: 3840px) {
          .projects-heading { font-size: 42px; margin-bottom: 40px; }
        }
        ...
        @media (min-width: 1400px) {
          .contact-page-container { max-width: 1400px; }
          .form-area { padding: 40px 72px; }
        }
        @media (min-width: 1700px) {
          .contact-page-container { max-width: 1600px; }
        }
        @media (min-width: 2000px) {
          .contact-page-body { font-size: 1.15rem; }
          .contact-page-container { max-width: 1800px; min-height: 700px; }
          .sidebar { width: 280px; min-width: 280px; }
          .form-area { padding: 48px 90px; }
          .form-title h2 { font-size: 28px; }
        }
        @media (min-width: 2560px) {
          .contact-page-container { max-width: 2200px; min-height: 800px; }
          .sidebar { width: 300px; min-width: 300px; }
        }
        @media (min-width: 3000px) {
          .contact-page-body { font-size: 1.4rem; }
          .contact-page-container { max-width: 2600px; min-height: 900px; }
          .sidebar { width: 340px; min-width: 340px; }
          .form-title h2 { font-size: 34px; }
        }
        @media (min-width: 3840px) {
          .contact-page-container { max-width: 3400px; min-height: 1000px; }
          .sidebar { width: 400px; min-width: 400px; }
          .form-area { padding: 60px 120px; }
          .form-title h2 { font-size: 40px; }
        }
      `}</style>
            ...
            <form className="form-area" onSubmit={handleSend}>
              ...
              {activeNav === "PROJECTS" && (
                <div className="projects-marquee-section">
                  <h3 className="projects-heading">Lists of projects accomplished</h3>
